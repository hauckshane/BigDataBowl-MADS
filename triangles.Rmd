...
# this is where we check the player positions
# tackles are next to guards, guards are next to centers
...
if((player1$position == "T" && player2$position == "C") | (player1$position == "C" && player2$position == "T")){
return FALSE
} 
