...
ggplot(plotdf, aes(x = bucket_angle_min, y = 1, fill = meanEPA)) +
  ...
  labs(title = "Ball Carrier's Greatest Total Change of Direction's Effect On EPA",
       subtitle = "As the ball carrier makes more significant maximal changes in direction, the mean EPA for the offense tends to decrease.", 
...
ggplot(plotdf, aes(x = bucket_angle_mean, y = 1)) +
  ...
  labs(title = "Ball Carrier's Greatest Relative Total Change of Direction's \nEffect On EPA", 
       subtitle = "Edges that force the ball carrier to make a more drastic cutback or bounce have a negative effect on EPA for the offense.",
       x = "Ball Carrier Relative Total Change of Direction", y = " ", 
       caption = "Relative Change < 0 = Cutbacks | Relative Change = 0 = Dive | Relative Change > 0 = Bounces",
...
ggplot(EIR_TC_plot, aes(x = bucket_angle_min, y = 1, fill = meanEIR)) +
  ...
  labs(title = "Edge Intensity Rating by Greatest Total Change of Direction", 
       subtitle = "Higher EIRs are associated with greater total change of ball carrier direction.", 
...
ggplot(EIR_RTC_plot, aes(x = bucket_angle_min, y = 1, fill = meanEIR)) +
  ...
  labs(title = "Edge Intensity Rating by Greatest Relative Total Change", 
       ...
       subtitle = "Relative Change < 0 = Cutbacks |  Relative Change = 0 = Dives | Relative Change > 0 = Bounces",
       fill = "EIR")  +
  theme_minimal() +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
p1 <- ggplot(quickest_set_plot, aes(x = bucket_angle_min, y = 1, fill = expected_EIR)) +
  ...
  labs(title = "EIR for Total Change of Direction Seconds After Handoff",
       subtitle  = "The longer it takes for the defense to establish the edge, \nweaker EIRs lead to an increase in direct running maneuvers.", 
       x = "Ball Carrier Total Change of Direction", y = "", 
       fill = "Edge Intensity Rating") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
  ...
  labs(caption = "Seconds after handoff: {closest_state}")
